    ...
    <>
      ...
      <CodeExamplesPage>
        ...
        <PageText>
          ...
          Check out live examples of my code by navigating through the menu.
        </PageText>
        ...
        <PageText>
          ...
          really works, or if it looks good. At the end of the day, code is just
          code. Seeing a live version that is functioning properly is just as
          important as reading the source code.
        </PageText>
        ...
        <PageText>
          ...
          examples of code I think is impressive or useful. It also proves my
          aptitude in implementing certain libraries and techniques, and it also
          serves as a central repository for myself. So if I want to remember
          how to implement a dropdown using Formik and React Select, I can look
          it up easily and see a working version. Pretty cool, no?
        </PageText>
